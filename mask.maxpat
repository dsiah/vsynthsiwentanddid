...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 329.5, 431.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 817.0, 640.25, 135.0, 22.0 ],
					"priority" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 834.0, 640.25, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 817.0, 519.75, 171.0, 115.0 ],
					"varname" : "vs_presets",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 718.0, 519.75, 95.0, 142.5 ],
					"varname" : "vs_render",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 455.0, 636.75, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 12.0, 12.0, 79.0, 316.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 248.0, 17.0, 215.0, 100.0 ],
					"varname" : "vs_wfg_rad",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 518.0, 17.0, 178.0, 132.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 338.0, 191.0, 49.0, 41.0 ],
					"varname" : "vs_op2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 518.0, 153.0, 122.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 219.0, 342.0, 139.0, 71.0 ],
					"varname" : "vs_luma_key",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 505.0, 328.0, 140.0, 48.0 ],
					"varname" : "vs_camera_s",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 251.5, 259.5, 139.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 151.0, 431.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 290.0, 572.0, 173.0, 45.0 ],
					"varname" : "vs_crssfade",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 518.0, 232.5, 144.0, 75.0 ],
					"varname" : "vs_huemod_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 707.0, 77.0, 75.0, 72.0 ],
					"varname" : "vs_lfo",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 160.5, 552.0, 135.0, 552.0, 135.0, 9.0, 504.0, 9.0, 504.0, 9.0, 527.5, 9.0 ],
					"order" : 0,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-12::obj-18" : [ "op2_op", "live.menu", 0 ],
			"obj-13::obj-31" : [ "clrizer_hue[3]", "Hue", 0 ],
			"obj-13::obj-60" : [ "clrizer_color[3]", "color", 0 ],
			"obj-14::obj-20" : [ "luma_invert", "live.text", 0 ],
			"obj-14::obj-21" : [ "luma_smth", "Smooth", 0 ],
			"obj-14::obj-3" : [ "luma_thrshld", "Threshold", 0 ],
			"obj-15::obj-18" : [ "live.text[3]", "live.text", 0 ],
			"obj-16::obj-17" : [ "chroma_color", "chroma", 0 ],
			"obj-16::obj-2" : [ "chroma_invert", "live.text", 0 ],
			"obj-16::obj-21" : [ "chroma_smth", "Smooth", 0 ],
			"obj-16::obj-27" : [ "led", "led", 0 ],
			"obj-16::obj-3" : [ "chroma_thrshld", "Threshold", 0 ],
			"obj-17::obj-22::obj-19" : [ "displacement_angle", "Angle", 0 ],
			"obj-17::obj-22::obj-29" : [ "live.numbox[1]", "live.numbox", 0 ],
			...
			"obj-18::obj-22::obj-52" : [ "MENU[5]", "angle", 0 ],
			"obj-18::obj-22::obj-55" : [ "MENU[6]", "angle", 0 ],
			...
			"obj-19::obj-4" : [ "crossfade", "CROSSFADE", 0 ],
			"obj-1::obj-10" : [ "vs_preset_name", "vs_preset_name", 0 ],
			"obj-1::obj-15" : [ "live.tab", "live.tab", 0 ],
			"obj-1::obj-32" : [ "live.numbox", "live.numbox", 0 ],
			"obj-20::obj-23" : [ "live.menu[12]", "live.menu", 0 ],
			"obj-20::obj-39" : [ "hm2_hm", "HM", 0 ],
			"obj-20::obj-46" : [ "hm2_hue", "Hue", 0 ],
			"obj-20::obj-48" : [ "hm2_sat", "Sat", 0 ],
			"obj-20::obj-5" : [ "live.menu[1]", "live.menu", 0 ],
			...
			"obj-3::obj-130" : [ "radwfg_time", "Time", 0 ],
			"obj-3::obj-139" : [ "radwfg_shape", "shape", 0 ],
			"obj-3::obj-23" : [ "radwfg_pwm", "PWM", 0 ],
			"obj-3::obj-24" : [ "radwfg_pw", "PW", 0 ],
			"obj-3::obj-25" : [ "radwfg_fm", "PM", 0 ],
			"obj-3::obj-26" : [ "radwfg_freq", "Freq", 0 ],
			"obj-3::obj-27" : [ "radwfg_wf", "waveform", 0 ],
			"obj-3::obj-28" : [ "live.text[2]", "live.text", 0 ],
			"obj-3::obj-32" : [ "radwfg_fm_range", "scale_freq_fm", 0 ],
			"obj-3::obj-35" : [ "radwfg_freq_range", "scale_freq", 0 ],
			"obj-3::obj-6" : [ "radwfg_time_dir", "inevrt", 0 ],
			...
			"obj-6::obj-10" : [ "bi_wfg_bias", "Bias", 0 ],
			"obj-6::obj-14" : [ "bi_wfg_bm", "BM", 0 ],
			"obj-6::obj-17" : [ "live.menu", "live.menu", 0 ],
			"obj-6::obj-22" : [ "live.toggle[1]", "live.toggle[1]", 0 ],
			"obj-6::obj-24" : [ "live.toggle", "live.toggle", 0 ],
			"obj-6::obj-29" : [ "bi_wfg_freq", "Freq", 0 ],
			"obj-6::obj-30" : [ "bi_wfg_angle", "Angle", 0 ],
			"obj-6::obj-4" : [ "bi_wfg_fm", "FM", 0 ],
			"obj-6::obj-41" : [ "bi_wfg_mode", "bipolarCol", 0 ],
			"obj-6::obj-42" : [ "live.toggle[2]", "live.toggle", 0 ],
			"obj-6::obj-53" : [ "bi_wfg_speed", "Speed", 0 ],
			"obj-6::obj-6" : [ "bi_wfg_pm", "PM", 0 ],
			"obj-6::obj-65" : [ "bi_wfg_shape", "Shape", 0 ],
			"parameterbanks" : 			{
