...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 720.0, 524.5, 167.0, 100.0 ],
					"presentation_linecount" : 8,
					"text" : "Play with the various displacement features \n\nAnd use the mixer to see how feedback can be used visibly and \"invisbly\" in the output solely to modulate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 736.0, 70.0, 143.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 558.0, 142.0, 60.0 ],
					"presentation_linecount" : 6,
					"text" : "2. Load Presets file \n(matching the filename)\nAnd then choose a white button"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 531.0, 107.0, 20.0 ],
					"text" : "1. Turn Render on"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 696.0, 315.0, 116.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 546.0, 315.0, 116.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 546.0, 151.0, 277.0, 100.0 ],
					"varname" : "vs_wfg_2[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"autorestore" : "arches-presets.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 678.5, 135.0, 22.0 ],
					"priority" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 127.0, 678.5, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 558.0, 171.0, 115.0 ],
					"varname" : "vs_presets",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 105.0, 85.0, 277.0, 100.0 ],
					"varname" : "vs_wfg_2[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 558.0, 95.0, 142.5 ],
					"varname" : "vs_render",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 346.0, 661.0, 162.0, 19.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 105.0, 311.0, 122.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 11.0, 15.0, 79.0, 316.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 546.0, 553.0, 169.0, 111.0 ],
					"varname" : "vs_mixer_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "vs_poltocar.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 696.0, 282.0, 64.0, 17.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 696.0, 402.0, 162.0, 119.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 546.0, 70.0, 178.0, 71.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 555.5, 267.0, 705.5, 267.0 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 555.5, 502.0, 630.5, 502.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 705.5, 533.0, 436.0, 533.0, 436.0, 72.0, 114.5, 72.0 ],
					"order" : 1,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 114.5, 505.0, 555.5, 505.0 ],
					"order" : 1,
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 114.5, 431.0, 531.0, 431.0, 531.0, 63.0, 555.5, 63.0 ],
					"order" : 0,
					"source" : [ "obj-9", 0 ]
				}
		...
		"parameters" : 		{
			"obj-15::obj-18" : [ "mixer3_master", "MASTER", 0 ],
			"obj-15::obj-2" : [ "mixer3_in_1", "IN1", 0 ],
			"obj-15::obj-3" : [ "mixer3_in_2", "IN2", 0 ],
			"obj-15::obj-4" : [ "mixer3_in_3", "IN3", 0 ],
			"obj-1::obj-10" : [ "vs_preset_name", "vs_preset_name", 0 ],
			"obj-1::obj-15" : [ "live.tab", "live.tab", 0 ],
			"obj-1::obj-32" : [ "live.numbox", "live.numbox", 0 ],
			"obj-20::obj-31" : [ "clrizer_hue[1]", "Hue", 0 ],
			"obj-20::obj-60" : [ "clrizer_color[1]", "color", 0 ],
			"obj-22::obj-31" : [ "clrizer_hue[2]", "Hue", 0 ],
			"obj-22::obj-60" : [ "clrizer_color[2]", "color", 0 ],
			"obj-24::obj-22::obj-19" : [ "displacement_angle", "Angle", 0 ],
			"obj-24::obj-22::obj-29" : [ "live.numbox[1]", "live.numbox", 0 ],
			"obj-24::obj-22::obj-35" : [ "displacement_zoom", "Zoom", 0 ],
			"obj-24::obj-22::obj-4" : [ "disp_ang_range", "angle", 0 ],
			"obj-24::obj-22::obj-40" : [ "displacement_y_m", "YM", 0 ],
			"obj-24::obj-22::obj-42" : [ "displacement_x_m", "XM", 0 ],
			"obj-24::obj-22::obj-44" : [ "displacement_zoom_m", "ZM", 0 ],
			"obj-24::obj-22::obj-47" : [ "displacement_angle_m", "AGLM", 0 ],
			"obj-24::obj-22::obj-52" : [ "MENU[1]", "angle", 0 ],
			"obj-24::obj-22::obj-55" : [ "MENU[2]", "angle", 0 ],
			"obj-24::obj-22::obj-56" : [ "MENU[3]", "angle", 0 ],
			"obj-24::obj-22::obj-57" : [ "MENU[4]", "angle", 0 ],
			"obj-24::obj-22::obj-6" : [ "offrot_x", "X", 0 ],
			"obj-24::obj-22::obj-67" : [ "menu", "angle", 0 ],
			"obj-24::obj-22::obj-8" : [ "displacement_y", "Y", 0 ],
			"obj-24::obj-33" : [ "displacement_init_point", "live.text", 2 ],
			"obj-24::obj-8" : [ "displacement_polar", "live.text", 2 ],
			"obj-24::obj-96" : [ "displacement_boundmode", "live.menu", 0 ],
			"obj-25::obj-19" : [ "offrot_angle", "Angle", 0 ],
			"obj-25::obj-35" : [ "offrot_zoom", "Zoom", 0 ],
			"obj-25::obj-4" : [ "MENU[6]", "angle", 0 ],
			"obj-25::obj-6" : [ "offrot_x[1]", "X", 0 ],
			"obj-25::obj-67" : [ "MENU", "angle", 0 ],
			"obj-25::obj-8" : [ "offrot_y", "Y", 0 ],
			"obj-25::obj-9" : [ "MENU[5]", "angle", 0 ],
			"obj-25::obj-96" : [ "offrot_boundmode", "live.menu", 0 ],
			"obj-2::obj-10" : [ "wfg2_pm[1]", "PM", 0 ],
			"obj-2::obj-12" : [ "wfg2_time_range", "wfg2_time_range", 0 ],
			...
			"obj-2::obj-28" : [ "live.toggle[5]", "live.toggle[1]", 0 ],
